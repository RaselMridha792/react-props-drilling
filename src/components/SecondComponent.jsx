...
const SecondComponent = ({country}) => {
  const {name, capital, region, flags, currencies, population} = country;
  return (
    <>
    <div className="capitalize text-left border rounded-xl bg-black p-5 flex flex-col items-center">
      <p>country name: {name.common}</p>
      <p>capital: {capital}</p>
      <p>region: {region}</p>
      <ThirdComponent {...country}></ThirdComponent>
